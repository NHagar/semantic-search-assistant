<script>
  ...
  let autoGenerateDescription = false;

  function handleDocumentsExtracted(event) {
    console.log("Documents extracted:", event.detail);
    autoGenerateDescription = event.detail.autoGenerateDescription || false;
    currentStep.set(1);
  }
  ...
  {:else}
    ...
    <div class="app-content">
      ...
      {:else if currentStepValue === 1}
        <div class="step-panel">
          <h2>Corpus Synopsis</h2>
          <p>
            A brief overview of your document corpus is being generated automatically.
          </p>
          <DocumentDescription
            autoGenerate={autoGenerateDescription}
